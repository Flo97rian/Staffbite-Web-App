...
export const FETCH_DEMO = '/getDemo';
export const FETCH_ALL_SHIFTPLANS_FOR_EMPLOYEE = '/getEmployeesShiftplans';
export const FETCH_SHIFTPLANS_FOR_EMPLOYEE = '/fetchShiftplansForEmployee';
...
export const CREATE_DEMO = '/createDemo';
export const CONTACT_FORM = '/contactForm';
export const SEND_REMINDER_FOR_APPLICATION = '/sendReminderForApplication';
