...
export const INFO_EMPLOYEE_IS_ACTIVE = "Tragen Sie ein, ob ihr Mitarbeiter direkt in die Schichtplannung mit aufgenommen werden soll";
export const INFO_EMPLOYEE_VACATION = "Tragen Sie hier ein, ob ihr Mitarbeiter gerade im Urlaub ist";
export const INFO_EMPLOYEE_OVERTIME = "Tragen Sie hier ein, ob ihr Mitarbeiter aktuell Überstunden hat und diese abgebaut werden sollen. Mit dieser Einstellung wird dieser Mitarbeiter bewusst weniger im Schichtplan eingesetzt.";
export const INFO_EMPLOYEE_HOURLY_WAGES = "Tragen Sie hier den Stundenlohn ein. Diesen können Sie später ändern";
export const INFO_EMPLOYEE_MONTHLY_INCOME = "Tragen Sie hier das vereinbarte Gehalt ein";
export const INFO_EMPLOYEE_MONTHLY_WORKING_HOURES = "Tragen Sie hier die monatlichen Arbeitsstunden ein";
