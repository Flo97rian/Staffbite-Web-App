...
const SchichtenTabelle = (props) => {
    return (
        ...
        <Row className="text-center" noGutters={true}>
            ...
            <Col xs={6}>
                <InfoOverlay infotitle="Verfügbarkeiten" description="Manchmal kommt es vor, dass sich niemand auf eine Schicht beworben hat. Aus diesem Grund müssen manchmal Schichten entgegen der Wunscharbeitszeiten aufgefüllt werden. In erster Linie zählen ihre angegebenen Verfügbarkeiten. Lediglich im Notfall möchten wir dafür sorgen, dass alle Mitarbeiter bei der Auffüllung gleich behandelt werden. Tragen Sie hier bitte dennoch ein, an welchen Tagen Sie auf keinen Fall arbeiten können. Wir versuchen ihre Angaben bestmöglich zu berücksichtigen! Zusatz: Diese Angaben sind streng vertraulich und können weder von Ihrem Chef noch von Ihren Kollegen eingesehen werden!" ></InfoOverlay>
            </Col>
            <Col xs={3}>
            </Col>
        </Row>
