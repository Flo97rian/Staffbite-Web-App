...
import SchichtplanTabelle from './SchichtplanListe/SchichtplanTabelle';
import ButtonSchichtAuswahl from './FormElements/ButtonSchichtAuswahl';
...
export default class TableContainer extends React.PureComponent {
    ...
    schichtHinzufuegen(e) {
        ...
        input[key] = "<br />"
        var info = key + "Color";
        if (this.state.neuerSchichtplan[key] == false) { var color = "dark"; } 
        else { var color = "" }});
            ...
            <Card className="shadow">
              ...
              <CardBody>
                <Row className="text-center" noGutters={true}>
                  ...
                  <ButtonSchichtAuswahl
                  b1titel="Schichtplan freigeben"
                  b2titel="Befüllung starten"
                  b3titel="Schichtplan auswählen"
                  b1onClick={this}
                  b1onClickVal=""
                  b2onClick={this}
                  b2onClickVal=""
                  b3onClick={this.showModal}
                  b3onClickVal="showSchichtplanAuswaehlen"
                  true={this}
