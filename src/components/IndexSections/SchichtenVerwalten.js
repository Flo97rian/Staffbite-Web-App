...
export default class SchichtenVerwalten extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
                        ...
                        {this.state.Schichtplan2.map(item => (
                            <Col xl={3} lg={6} md={6} sm={6} xs={12}>
                                <ListGroup>
                                    <ListGroup.Item action variant="primary"> {item.Datum}</ListGroup.Item>
                                    <ListGroup.Item action variant="primary"> {item.Wochentag}</ListGroup.Item>
                                    <ListGroup.Item action variant="primary"> {item.Schicht1}</ListGroup.Item>
                                    <ListGroup.Item action variant="primary"> {item.Schicht2}</ListGroup.Item>
                                    <ListGroup.Item action variant="primary"> {item.Schicht3}</ListGroup.Item>
                                    <ListGroup.Item action variant="primary"> {item.Schicht4}</ListGroup.Item>
                                    <ListGroup.Item action variant="primary"> {item.Summe}</ListGroup.Item>
                                </ListGroup>
                            </Col>
                            ))} 
